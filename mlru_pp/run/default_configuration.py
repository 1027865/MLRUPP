...
import mlru_pp
from mlru_pp.paths import network_training_output_dir, preprocessing_output_dir, default_plans_identifier
from batchgenerators.utilities.file_and_folder_operations import *
from mlru_pp.experiment_planning.summarize_plans import summarize_plans
...
def get_default_configuration(network, task, network_trainer, plans_identifier=default_plans_identifier,
                              search_in=(mlru_pp.__path__[0], "training", "network_training"),
                              base_module='mlru_pp.training.network_training'):
    ...
    if task == 'Task001_ACDC':
        ...
        plans['plans_per_stage'][Stage]['batch_size'] = 12
