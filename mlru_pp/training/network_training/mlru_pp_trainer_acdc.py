...
from mlru_pp.training.network_training.Trainer_acdc import Trainer_acdc
...
from mlru_pp.network_architecture.acdc.mlru_pp_acdc import MLRU_PP
#
from fvcore.nn import FlopCountAnalysis


class mlru_pp_trainer_acdc(Trainer_acdc):
    """
