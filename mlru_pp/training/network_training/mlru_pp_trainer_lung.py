...
from mlru_pp.training.network_training.Trainer_lung import Trainer_lung
...
from mlru_pp.network_architecture.lung.mlru_pp_lung import MLRU_PP

from fvcore.nn import FlopCountAnalysis


class mlru_pp_trainer_lung(Trainer_lung):
    """
