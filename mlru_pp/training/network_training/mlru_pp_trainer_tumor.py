...
from mlru_pp.network_architecture.tumor.mlru_pp_tumor import MLRU_PP
# from shared.USDN.MED.M3D_CAP.Brats2017.MLRU.mlru_pp.network_architecture.tumor.mlru_pp_tumor import UNETR_PP
...
from mlru_pp.training.network_training.Trainer_tumor import Trainer_tumor
...
class mlru_pp_trainer_tumor(Trainer_tumor):
    """
